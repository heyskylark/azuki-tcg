...
// Garden to your hand: Return up to 1 entity with cost <= 2 in your opponent's
...
bool stt02_009_validate(ecs_world_t *world, ecs_entity_t card,
                        ecs_entity_t owner) {
...
bool stt02_009_validate_cost_target(ecs_world_t *world, ecs_entity_t card,
