...
#define ABILITY_INDEX_PARAM { AZK_ACTION_PARAM_ABILITY_INDEX, 0, 7 }
...
static const AzkActionSpec ACTION_SPECS[] = {
  ...
  },
  {
    ...
    .phase_mask = AZK_PHASE_MASK(PHASE_MAIN) | AZK_PHASE_MASK(PHASE_RESPONSE_WINDOW),
    .params = { HAND_INDEX_PARAM, ABILITY_INDEX_PARAM, BOOL_PARAM }
  },
  {
    .type = ACT_ACTIVATE_ALLEY_ABILITY,
    .phase_mask = AZK_PHASE_MASK(PHASE_MAIN) | AZK_PHASE_MASK(PHASE_RESPONSE_WINDOW),
    .params = { ABILITY_INDEX_PARAM, ALLEY_INDEX_PARAM, UNUSED_PARAM }
  },
  {
    .type = ACT_ACTIVATE_GARDEN_OR_LEADER_ABILITY,
    .phase_mask = AZK_PHASE_MASK(PHASE_MAIN) | AZK_PHASE_MASK(PHASE_RESPONSE_WINDOW),
    .params = { GARDEN_OR_LEADER_PARAM, ABILITY_INDEX_PARAM, BOOL_PARAM }
  },
  {
