...
#define ATTACK_TARGET_PARAM { AZK_ACTION_PARAM_GARDEN_OR_LEADER_INDEX, 0, GARDEN_SIZE + ALLEY_SIZE }
...
static const AzkActionSpec ACTION_SPECS[] = {
  ...
  },
  {
    .type = ACT_ATTACK,
    .phase_mask = AZK_PHASE_MASK(PHASE_MAIN),
    .params = { GARDEN_OR_LEADER_PARAM, ATTACK_TARGET_PARAM, UNUSED_PARAM }
  },
  {
