...
typedef enum {
  ...
  AZK_ACTION_PARAM_ABILITY_ZONE,
  AZK_ACTION_PARAM_ABILITY_SLOT,
  AZK_ACTION_PARAM_PLAYER_INDEX,
  AZK_ACTION_PARAM_TARGET_ZONE_KIND,
  AZK_ACTION_PARAM_ABILITY_INDEX
} AzkActionParamKind;
