...
def _apply_checkpoint_resume_policy_config(trainer_args: dict, checkpoint: Path | None) -> None:
  ...
  for source_key, target_key, caster in (
    ...
    ("policy_public_card_encoder_type", "public_card_encoder_type", str),
    ("policy_public_card_transformer_heads", "public_card_transformer_heads", int),
    ("policy_public_card_transformer_layers", "public_card_transformer_layers", int),
    ("policy_public_card_transformer_ff_size", "public_card_transformer_ff_size", int),
