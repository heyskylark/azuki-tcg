...
class AzukiTCG(AzukiTCGV1):
  """V2 AEC wrapper that augments observations with previous sampled action."""
  ...
  def observe(self, agent):
    ...
    return self._augment_previous_action(self.possible_agents[idx], obs)
  ...
  def step(self, action):
    ...
    if acting_agent is not None:
      self._record_previous_action(acting_agent, action)
