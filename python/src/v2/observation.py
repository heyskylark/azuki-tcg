...
class _TrainingPreviousActionObservationData(ctypes.Structure):
    _fields_ = [
        ("has_action", ctypes.c_bool),
...
def _previous_action_space() -> spaces.Dict:
    return spaces.Dict(
        {
            "has_action": _bool_space(),
    ...
    return spaces.Dict(
        {
            ...
            "previous_action": _previous_action_space(),
            "player": player_space,
...
def _previous_action_to_dict(previous_action: Any) -> dict[str, int]:
    has_action = int(bool(getattr(previous_action, "has_action", 0)))
    primary = int(getattr(previous_action, "primary", 0))
    sub1 = int(getattr(previous_action, "sub1", 0))
    sub2 = int(getattr(previous_action, "sub2", 0))
    sub3 = int(getattr(previous_action, "sub3", 0))
    ...
    return {
        ...
        "sub2": sub2,
        "sub3": sub3,
        "was_noop": int(bool(getattr(previous_action, "was_noop", 0))),
    }
...
def observation_to_dict(observation: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "previous_action": _previous_action_to_dict(
